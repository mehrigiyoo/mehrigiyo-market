    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=20, unique=True, validators=[config.validators.PhoneValidator()])),
                ('role', models.CharField(choices=[('client', 'Client'), ('doctor', 'Doctor'), ('operator', 'Operator')], default='client', max_length=20)),
                ...
                ('notification_key', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.AddIndex(
            model_name='smscode',
            index=models.Index(fields=['phone'], name='account_sms_phone_90ddc7_idx'),
        ),
        migrations.AddIndex(
            model_name='smscode',
            index=models.Index(fields=['expire_at'], name='account_sms_expire__caed62_idx'),
        ),
        migrations.AddField(
            model_name='regionmodel',
            name='country',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='account.countymodel'),
        ),
        migrations.AddField(
            model_name='referrals',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='referrals', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
